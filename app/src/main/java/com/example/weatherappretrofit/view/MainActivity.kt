package com.example.weatherappretrofit.view
...
import com.example.weatherappretrofit.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var cName = GET.getString("cityName", "")?.lowercase(Locale.ROOT)
        ...
        swipe_refresh_layout.setOnRefreshListener {
            ...
            var cityName = GET.getString("cityName", cName)?.lowercase(Locale.ROOT)
